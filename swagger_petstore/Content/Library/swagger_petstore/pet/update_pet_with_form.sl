...
#! @input pet_id: ID of pet that needs to be updated
#! @input name: Updated name of the pet
#! @input status: Updated status of the pet
...
flow:
  ...
  - http_client_action:
      ...
      do:
        ...
        - form_params: ${'name='+name+'&'+'status='+status}
        - url: ${url}
